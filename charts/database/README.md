...
### initdb section in values.yaml

There is a ConfigMap object created in templates/initdb-script-configmap.yaml where you can put the sql commands to set up the database (db name, tables etc).
